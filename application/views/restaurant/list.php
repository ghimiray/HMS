            ...
            <div class="row">
                <div class="span12">
                    <a href="javascript:open_form();" class="btn btn-small btn-success"><i
                            class="btn-icon-only icon-plus"></i>Add Restaurant Service</a>
                    ...
                    <hr>
                    <a href="<?php echo base_url('restaurant/add') ?>" class="btn btn-small btn-primary"><i
                        ...
                        if ($restaurants)
                            foreach ($restaurants as $rest) { ?>
                                <tr>
                                    ...
                                    <td> <?php echo $rest->restaurant_open_time ?> </td>
                                    <td> <?php echo $rest->restaurant_close_time ?> </td>
                                    <td> <?php echo $rest->restaurant_details ?> </td>
                                    <td> <?php echo $rest->table_count ?> </td>
                                    <td style="width:150px;text-align: center"><a
                                            href="<?php echo base_url('restaurant/edit/' . $rest->restaurant_name) ?>"
                                            class="btn btn-small btn-primary"><i
                                                class="btn-icon-only icon-edit"> </i></a> | <a
                                            href="<?php echo base_url('restaurant/delete/' . $rest->restaurant_name) ?>"
