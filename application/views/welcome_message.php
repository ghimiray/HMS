              ...
              <div class="widget big-stats-container">
                <div class="widget-content">
                  ...
                  <div id="big_stats" class="cf">
                    <!-- <div class="stat"> <i class="icon-anchor"></i> <span class="value"><?php echo @$today_stats["roomservice"]?></span> <br>Room Service </div> -->
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-fire"></i> <span class="value"><?php echo @$today_stats["restaurant"]?></span> <br>Restaurant</div>
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-trophy"></i> <span class="value"><?php echo @$today_stats["sport"]?></span> <br>Sport </div>
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-user-md"></i> <span class="value"><?php echo @$today_stats["medicalservice"]?></span> <br>Medical Service </div>
                    <!-- .stat --> 
                  <!-- </div>
                  <div id="big_stats" class="cf">
                    <div class="stat"> <i class="icon-truck"></i> <span class="value"><?php echo @$today_stats["laundry"]?></span> <br>Laundry Service </div> -->
                    <!-- .stat --> 

                    <div class="stat"> <i class="icon-retweet"></i> <span class="value"><?php echo @$today_stats["massage"]?></span> <br>Massage Service </div>
                    <!-- .stat --> 
                  </div>
                </div>
                <!-- /widget-content --> 
              ...
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> <?php echo $cust->customer_TCno?> </td>
                    <td> <?php echo $cust->checkin_count?></td>
                    <td> <?php echo $cust->total_paid?></td>
          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <div class="shortcuts">
                ...
                <a href="<?php echo base_url() ?>logout" class="shortcut"><i class="shortcut-icon icon-off"></i><span class="shortcut-label">Logout</span> </a>
