<div class="main">
    <div class="main-inner">
        <div class="container">
            <div class="row">
                <div class="span12">
                    <a href="javascript:open_form();" class="btn btn-small btn-success"><i
                            class="btn-icon-only icon-plus"></i>Add Sport Service</a>
                    ...
                    <hr>
                    <a href="<?php echo base_url('sport_facility/add') ?>" class="btn btn-small btn-primary"><i
                            class="btn-icon-only icon-ok"></i>Add Sport Facility</a>
                    <br><br>
                    <table class="table table-striped table-bordered">
                        ...
                        if ($sportFacilities)
                            foreach ($sportFacilities as $sport) {
                                ...
                                ?>
                                <tr>
                                    <td> <?php echo $sport->sportfacility_open_time ?> </td>
                                    <td> <?php echo $sport->sportfacility_close_time ?> </td>
                                    <td> <?php echo $sport->sportfacility_details ?> </td>
                                    <td class="td-actions"><a
                                            href="<?php echo base_url('sport_facility/edit/'.$sport->sportfacility_id )?>"
                                            class="btn btn-small btn-primary"><i
                                                class="btn-icon-only icon-edit"> </i></a><a
                                            href="<?php echo base_url('sport_facility/delete/'.$sport->sportfacility_id )?>"
